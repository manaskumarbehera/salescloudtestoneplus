...
public class ProductCategoryNamePriceAndCountRowPanel extends ComponentWithLabelAndValidationPanel<FormComponent<Object>> {

	public ProductCategoryNamePriceAndCountRowPanel(ComponentContainerPanel container, final String fieldName) {
		super(container, fieldName);
		init(new ProductCategoryNamePriceAndCountRowEditor("editor", propertyModel) {
			@Override
