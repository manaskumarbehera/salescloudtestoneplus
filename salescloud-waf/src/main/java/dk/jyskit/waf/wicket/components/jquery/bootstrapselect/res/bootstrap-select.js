    ...
    Selectpicker.prototype = {
        ...
        createA: function(text, classes, inline) {
            return '<a tabindex="0" class="'+classes+'" style="'+inline+'">' +
                 text +
                 // PALFRED change to fontawesome
                 '<i class="fa fa-check-square-o icon-ok check-mark"></i>' +
                 '</a>';
        },
        ...
        render: function() {
            ...
            var selectedItems = this.$element.find('option:selected').map(function() {
                var $this = $(this);
                var icon = $this.data('icon') && that.options.showIcon ? '<i class="' + $this.data('icon') + '"></i> ' : '';
                var subtext;
...
//  Jan: how to localize??      noneSelectedText : 'Nothing selected',
        noneSelectedText : '',
