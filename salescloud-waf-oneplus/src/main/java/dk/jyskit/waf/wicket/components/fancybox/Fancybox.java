 ...
 *  under the License.
 */
package dk.jyskit.waf.wicket.components.fancybox;
...
import dk.jyskit.waf.wicket.components.images.imagereference.ImageReference;
 ...
 */
public class Fancybox extends WebMarkupContainer {
    ...
    protected void onComponentTag(ComponentTag tag) {
        ...
        if (isImage()) {
            ...
            tag.put("href", this.iframeURL.getObject().toString());
        } else if (isDiv()) {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        if (autoAddToHeader()) {
        	response.render(JavaScriptReferenceHeaderItem.forReference(new PackageResourceReference(getClass(), "jquery.fancybox-1.3.1.js")));
            if (isMouseWheelEnabled()) {
            	response.render(JavaScriptReferenceHeaderItem.forReference(new PackageResourceReference(getClass(), "jquery.mousewheel-3.0.2.pack.js")));
            }
        	response.render(CssReferenceHeaderItem.forReference(new PackageResourceReference(getClass(), "jquery.fancybox-1.3.1.css")));
        }
