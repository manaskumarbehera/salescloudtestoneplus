package dk.jyskit.waf.wicketbootstrap.icons.fontawesome;
...
public class FontAwesomeIconTypeBuilder {
    ...
    public static enum FontAwesomeGraphic {
        ...
        arrow_right, arrow_up, arrows, arrows_alt, arrows_h, arrows_v, asterisk, backward, ban, bank, bar_chart_o, barcode,
        bars, beer, bell, bell_o, bicycle, bitbucket, bitbucket_square, bold, bolt, book, bookmark, bookmark_o, briefcase, btc,
        ...
        heart, heartbeat, heart_o, home, hospital_o, html5, inbox, indent, info, info_circle, inr, instagram, italic, jpy, key,
        ...
        rss_square, rub, rupee, save, scissors, search, share, share_square, share_square_o, shield, ship, shopping_cart,
        ...
        twitter_square, umbrella, underline, undo, unlink, unlock, unlock_alt, unsorted, upload, usd, user, user_plus, user_md,
