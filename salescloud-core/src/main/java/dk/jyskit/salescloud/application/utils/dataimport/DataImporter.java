...
import dk.jyskit.salescloud.application.utils.dataimport.csv.TabularCSVReader;
import dk.jyskit.salescloud.application.utils.dataimport.excel.TabularExcelReader;
...
//				}
//				positionToColumnMap.put(col, header.toLowerCase());
